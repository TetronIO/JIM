...
public interface IConnectorImportUsingFiles
{
    ...
    /// <param name="progress">Narrates what you are doing, and moves between the phases you declared through <see cref="IConnectorPhases"/> (i.e. "Reading CSV file...", "Parsed 50,000 rows..."). Never null. The whole file is read in this one call, so this is the only progress an administrator sees until it returns. The vocabulary is yours; emit on phase and page boundaries rather than per row.</param>
