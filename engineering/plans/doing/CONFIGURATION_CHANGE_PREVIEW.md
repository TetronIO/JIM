...
- **Status:** Doing (Phases 0 and 2 complete; Phase 3 underway: persistence and the adapter contract landed, orchestration next. Phase 3 is not done until the #1114 pilot adapter ships on it)
- **Created:** 2026-07-20
