...
<#
.SYNOPSIS
    Test Scenario 003: GALSYNC (Global Address List Synchronisation)
...
.DESCRIPTION
    ...
    and Sync Rules. Use Setup-Scenario-003.ps1 first (when available).
...
.EXAMPLE
    ./Invoke-Scenario-003-GALSYNC.ps1 -Step All -Template Medium
#>
...
Write-TestSection "Scenario 003: GALSYNC ($Step)"
