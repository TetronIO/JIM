...
**Milestone: 44 closed / 34 open (78 total, ~56% complete)** as of 2026-07-15. The milestone has grown beyond the original 57-issue analysis as new issues were raised, so the fixed "in-scope" denominator no longer tracks it; counts here follow the live milestone. **Reconciliation (2026-07-15):** every issue/PR reference in this document that is closed or merged has been struck through; the live milestone remains the authoritative source for current counts. Latest pass closed off [#376](https://github.com/TetronIO/JIM/issues/376) (CRUD custom Metaverse Object Types, merged via PR [#1039](https://github.com/TetronIO/JIM/pull/1039)) and its spun-out [#1040](https://github.com/TetronIO/JIM/issues/1040) (`hasAttribute:` presence search, merged via PR [#1041](https://github.com/TetronIO/JIM/pull/1041)). Four issues have also left this milestone since the analysis: [#9](https://github.com/TetronIO/JIM/issues/9) and [#294](https://github.com/TetronIO/JIM/issues/294) moved to v2.0-IGA-FOUNDATION; [#186](https://github.com/TetronIO/JIM/issues/186) and [#437](https://github.com/TetronIO/JIM/issues/437) removed to the backlog (no milestone). They are struck through in the priority tiers (Section 3) and full issue index (Section 8); scattered cross-references elsewhere are left in place as context.

`█████████████░░░░░░░░░░` 44/78 closed

**New issues raised since the analysis:** [#959](https://github.com/TetronIO/JIM/issues/959) surface unresolved references clearly (v1.0); ~~[#979](https://github.com/TetronIO/JIM/issues/979) PowerShell PascalCase output~~ (**done:** merged), spun out of ~~[#813](https://github.com/TetronIO/JIM/issues/813)~~ (**done**) (v1.0); ~~[#1040](https://github.com/TetronIO/JIM/issues/1040) Metaverse Object search by attribute presence (`hasAttribute:`)~~ (**done:** merged via PR [#1041](https://github.com/TetronIO/JIM/pull/1041)), spun out of ~~[#376](https://github.com/TetronIO/JIM/issues/376)~~ (**done**) (v1.0); [#944](https://github.com/TetronIO/JIM/issues/944) GALSYNC cross-forest contact sync (placed on v1.x-CONNECTORS). Per-priority breakdowns are best read from the live milestone; the fixed per-priority table has been retired as unmaintainable against a moving milestone.
...
| **Metaverse schema and config management** | ~~[#377](https://github.com/TetronIO/JIM/issues/377)~~ (done), ~~[#376](https://github.com/TetronIO/JIM/issues/376)~~ (done), [#348](https://github.com/TetronIO/JIM/issues/348), [#359](https://github.com/TetronIO/JIM/issues/359), ~~[#85](https://github.com/TetronIO/JIM/issues/85)~~ (done), ~~[#813](https://github.com/TetronIO/JIM/issues/813)~~ (done) | 6 |
...
| ~~[#376](https://github.com/TetronIO/JIM/issues/376) CRUD custom Metaverse Object Types~~ **Done:** merged via PR [#1039](https://github.com/TetronIO/JIM/pull/1039) (app layer, REST API, PowerShell, Web UI, delete/rename/attribute-unassign safeguards, `hasAttribute:` presence search [#1040](https://github.com/TetronIO/JIM/issues/1040), docs). | ~~High~~ |
...
| ~~[#9](https://github.com/TetronIO/JIM/issues/9) Synchronisation Readers role~~ **Moved to v2.0-IGA-FOUNDATION** (no longer a v1.0 blocker). | ~~Medium~~ |
...
| [#359](https://github.com/TetronIO/JIM/issues/359) Configuration migration | XL, everything open; DB-backup-based config backup is a documented workaround. Design after ~~[#376](https://github.com/TetronIO/JIM/issues/376)~~ (done)/~~[#377](https://github.com/TetronIO/JIM/issues/377)~~ (done) stabilise the config surface anyway. |
...
| **D5: API controllers + PowerShell module** | `MetaverseController`, `SecurityController`, PS module | ~~[#154](https://github.com/TetronIO/JIM/issues/154) merge~~ (done, PR [#897](https://github.com/TetronIO/JIM/pull/897)) → ~~[#467](https://github.com/TetronIO/JIM/issues/467) verify/close~~ (done) → ~~[#466](https://github.com/TetronIO/JIM/issues/466) rescope~~ (done, PR [#901](https://github.com/TetronIO/JIM/pull/901)) → ~~[#813](https://github.com/TetronIO/JIM/issues/813) (normalise contract **before** new surfaces are added)~~ (done) → [#487](https://github.com/TetronIO/JIM/issues/487) → then ~~[#377](https://github.com/TetronIO/JIM/issues/377)~~ (done)/~~[#376](https://github.com/TetronIO/JIM/issues/376)~~ (done) API gap-fill |
...
| **D7: Audit / security** | `ChangeHistoryServer`, history UI, roles/policies | ~~[#14](https://github.com/TetronIO/JIM/issues/14) gap-close~~ (done) → ~~[#9](https://github.com/TetronIO/JIM/issues/9)~~ (moved to v2.0) → [#881](https://github.com/TetronIO/JIM/issues/881). ~~[#500](https://github.com/TetronIO/JIM/issues/500)~~ (done)'s audit-trail item was designed against ~~[#14](https://github.com/TetronIO/JIM/issues/14)~~ (done) (one audit system, not two); its other items are independent. |
...
| Security (D7) | ~~[#9](https://github.com/TetronIO/JIM/issues/9) Readers role~~ (moved to v2.0); ~~[#500](https://github.com/TetronIO/JIM/issues/500) rate limiting, CSP, lockfiles~~ (done) |
...
Sync engine: [#435](https://github.com/TetronIO/JIM/issues/435) → [#873](https://github.com/TetronIO/JIM/issues/873)/[#872](https://github.com/TetronIO/JIM/issues/872) (D1); Preview: [#288](https://github.com/TetronIO/JIM/issues/288) engine build; [#242](https://github.com/TetronIO/JIM/issues/242) implementation once PRD approved; Schema: ~~[#376](https://github.com/TetronIO/JIM/issues/376)~~ (done, PR [#1039](https://github.com/TetronIO/JIM/pull/1039)); Security: [#881](https://github.com/TetronIO/JIM/issues/881), ~~[#500](https://github.com/TetronIO/JIM/issues/500) audit trail (unified with [#14](https://github.com/TetronIO/JIM/issues/14))~~ (both done); LDAP: [#351](https://github.com/TetronIO/JIM/issues/351) Phase 1, [#231](https://github.com/TetronIO/JIM/issues/231); UI: [#169](https://github.com/TetronIO/JIM/issues/169) health-slice dashboard; Release: [#636](https://github.com/TetronIO/JIM/issues/636) Phases 1-3.
...
7. ~~**[#9](https://github.com/TetronIO/JIM/issues/9):** exactly what a Synchronisation Reader can see (Activities, CSO/MVO detail, Pending Exports; presumably not connector credentials) - interlocks with decision 8.~~ **Moved to v2.0-IGA-FOUNDATION** (no longer a v1.0 decision).
...
18. ~~**[#186](https://github.com/TetronIO/JIM/issues/186):** create the Tetron service account and PowerShell Gallery co-owner invite; provide the API key for CI secrets.~~ **Removed from the v1.0 milestone** (currently unassigned).
...
|---|---|---|---|---|---|---|
| ~~9~~ | ~~Synchronisation Readers role~~ | Security/RBAC | **Moved to v2.0** | ~~Medium~~ | D7 | Moved to v2.0-IGA-FOUNDATION since the analysis |
...
| ~~186~~ | ~~PS Gallery ownership transfer~~ | Release ops | **Removed** | ~~Low~~ | Ops | Removed from the v1.0 milestone (currently unassigned) |
...
| ~~294~~ | ~~Integration testing deferred tasks~~ | Testing | **Moved to v2.0** | ~~Medium (rescoped)~~ | D8 | Rescoped and moved to v2.0-IGA-FOUNDATION |
...
| 359 | Configuration migration | Config mgmt | **Low → v1.x** | High | - | Defer; design after ~~[#376](https://github.com/TetronIO/JIM/issues/376)~~ (done)/~~[#377](https://github.com/TetronIO/JIM/issues/377)~~ (done) stabilise |
| ~~376~~ | CRUD custom MV Object Types | Schema | **Done** | ~~High~~ | D5 tail | Merged via PR [#1039](https://github.com/TetronIO/JIM/pull/1039); includes the `hasAttribute:` presence search ([#1040](https://github.com/TetronIO/JIM/issues/1040), PR [#1041](https://github.com/TetronIO/JIM/pull/1041)) |
...
| ~~437~~ | ~~Evaluate sync partition scoping~~ | Design | **Removed** | ~~Low~~ | Doc | Assessed (won't-do/defer) and removed from the milestone to the backlog |
...
| 881 | Sensitive value access control | Audit/security | High | Medium | D7 | After ~~[#14](https://github.com/TetronIO/JIM/issues/14)~~ (done) and ~~[#9](https://github.com/TetronIO/JIM/issues/9)~~ (moved to v2.0) |
