...
- **JIM.Worker processing large datasets** — bulk imports, full syncs of large directories, or complex Synchronisation Rules with many joins can cause the worker to consume significantly more memory than the ~300MB baseline.
