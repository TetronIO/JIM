...
Write-Host "  ${GREEN}•${NC} Adminer:      ${BLUE}http://localhost:8080${NC}"
Write-Host ""
Write-Host "${GRAY}Next Steps:${NC}"
Write-Host "  1. Create API key:  ${BLUE}pwsh test/integration/Setup-InfrastructureApiKey.ps1${NC}"
Write-Host "  2. Run tests:       ${BLUE}pwsh test/integration/scenarios/Invoke-Scenario1-HRToDirectory.ps1 -Template Nano -ApiKey (Get-Content test/integration/.api-key)${NC}"
Write-Host ""
