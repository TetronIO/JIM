...
public class SchedulingRepositoryWatermarkTests
{
    ...
    {
        var older = Execution(_scheduleId, ScheduleExecutionStatus.Complete, new DateTime(2026, 1, 1, 0, 0, 0, DateTimeKind.Utc));
        var newer = Execution(_scheduleId, ScheduleExecutionStatus.Complete, new DateTime(2026, 1, 2, 0, 0, 0, DateTimeKind.Utc));
    ...
    public async Task GetLastCompletedScheduleExecutionAsync_CompletedAtOrAfterBound_IsExcludedAsync()
    {
        ...
        _executionsData.Add(Execution(_scheduleId, ScheduleExecutionStatus.Complete, bound)); // equal to bound: excluded
        _executionsData.Add(Execution(_scheduleId, ScheduleExecutionStatus.Complete, bound.AddHours(1))); // after bound: excluded
        BuildRepository();
    ...
    {
        _executionsData.Add(Execution(_otherScheduleId, ScheduleExecutionStatus.Complete, new DateTime(2026, 1, 2, 0, 0, 0, DateTimeKind.Utc)));
        BuildRepository();
