...
<#
.SYNOPSIS
    Configure JIM for Scenario 018: writeback into the Connected System being synchronised (#1284)
...
$hrSystemName      = "Scenario 018 HR"
$controlSystemName = "Scenario 018 Control"
$hrCsvFilePath      = "/connector-files/test-data/scenario-018-hr.csv"
$controlCsvFilePath = "/connector-files/test-data/scenario-018-control.csv"
...
Write-TestSection "Scenario 018 Setup: writeback into the source Connected System"
...
$hr      = New-Scenario18System -Name $hrSystemName      -Description "Scenario 018: source of identity, and the target of its own writeback rule" -FilePath $hrCsvFilePath
$control = New-Scenario18System -Name $controlSystemName -Description "Scenario 018: control target, fed by the same Metaverse Objects"            -FilePath $controlCsvFilePath
...
$writebackRule = New-JIMSyncRule `
    -Name "Scenario 018 HR Writeback" `
...
$controlRule = New-JIMSyncRule `
    -Name "Scenario 018 Control Export" `
...
Write-TestSection "Scenario 018 Setup Complete"
