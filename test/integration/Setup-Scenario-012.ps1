...
<#
.SYNOPSIS
    Configure JIM for Scenario 012: Relative-Date Inbound Scoping (joiner / leaver window)
...
.DESCRIPTION
    ...
    directory is already covered by Scenario 010. Keeping this Metaverse-only makes it fast and
...
.EXAMPLE
    ./Setup-Scenario-012.ps1 -JIMUrl "http://localhost:5200" -ApiKey "jim_abc123..."
#>
...
$hrCsvFilePath = "/connector-files/test-data/scenario-012-hr-users.csv"

Write-TestSection "Scenario 012 Setup: Relative-Date Inbound Scoping"
...
Write-TestSection "Scenario 012 Setup Complete"
