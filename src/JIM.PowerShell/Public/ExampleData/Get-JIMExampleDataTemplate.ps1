function Get-JIMExampleDataTemplate {
    <#
    .SYNOPSIS
    ...
    .EXAMPLE
        Get-JIMExampleDataTemplate -Id 1

        Gets a specific template by ID.

    .EXAMPLE
        Get-JIMExampleDataTemplate -Name 'Test Users'
    ...
    process {
        ...
        switch ($PSCmdlet.ParameterSetName) {
            { $_ -in 'ById', 'ByName' } {
                ...
                $result = Invoke-JIMApi -Endpoint "/api/v1/example-data/templates/$Id"
                $result
            }
            ...
            'List' {
                ...
                $response = Invoke-JIMApi -Endpoint "/api/v1/example-data/templates?$queryString"
