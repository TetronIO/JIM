...
- **Status:** Done
- **Note:** All in-scope acceptance criteria are delivered. Rollback / restore (this PRD's explicit fast-follow and a Non-Goal for this release) is deferred until there is demand and tracked under [#942](https://github.com/TetronIO/JIM/issues/942).
- **Created:** 2026-06-25
- **Author:** JayVDZ
