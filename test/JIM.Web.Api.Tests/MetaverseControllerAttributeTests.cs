...
public class MetaverseControllerAttributeTests
{
    ...
    public void SetUp()
    {
        ...
        // Default: no Synchronisation Rule references and no stored values (so existing delete tests pass)
    ...
    public async Task DeleteAttributeAsync_WithSyncRuleReferences_ReturnsValidationError()
    {
        ...
        Assert.That(error.Message, Does.Contain("Synchronisation Rule(s)"));
    }
