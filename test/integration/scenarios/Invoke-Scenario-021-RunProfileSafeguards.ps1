...
<#
.SYNOPSIS
    Test Scenario 021: Run Profile Safeguards
...
.DESCRIPTION
    ...
    a share of the Connector Space). Reuses the Scenario 001 fixture (CSV HR source, LDAP target). A run
...
.EXAMPLE
    ./Invoke-Scenario-021-RunProfileSafeguards.ps1 -Step All -Template Nano -ApiKey "jim_..."

.EXAMPLE
    ./Invoke-Scenario-021-RunProfileSafeguards.ps1 -Step ExportLimit -Template Nano -ApiKey $env:JIM_API_KEY
#>
...
Write-TestSection "Scenario 021: Run Profile Safeguards"
...
try {
    ...
    # Seed CSV test data before Setup-Scenario-001.ps1 runs: its schema-import step opens hr-users.csv
    ...
    Write-Host "`n✗ Scenario 021 FAILED" -ForegroundColor Red
