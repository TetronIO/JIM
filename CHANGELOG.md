...
- 🐛 The causality view's **Technical names** toggle now also rewords the summary sentence above the views. That sentence is the first thing read on the page and it kept its plain-language stand-ins ("the record", "Identity") whatever the toggle said, which read as the toggle having failed; it now says "the Connected System Object" and "Metaverse Object" alongside the views beneath it. (#1087)
