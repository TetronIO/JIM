...
**Status**: running against both providers, and green. The default tier passes every functional row: 17 of 17 cells on Microsoft SQL Server and 19 of 19 on Oracle Database, with none reported as not exercised (August 2026, [#170](https://github.com/TetronIO/JIM/issues/170)). This is the correctness gate for the JIM SQL Connector.
