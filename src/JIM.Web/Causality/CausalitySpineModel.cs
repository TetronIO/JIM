...
/// <summary>
/// The object spine for one Run Profile Execution Item (#1495): the item's causal story projected
...
/// </summary>
public sealed class CausalitySpineModel
{
    /// <summary>
    ...
    /// </summary>
    public required IReadOnlyList<CausalitySpineColumn> Columns { get; init; }
    ...
    /// single-column story).
    /// </summary>
    public required IReadOnlyList<CausalitySpineJoin> Joins { get; init; }
