...
| Scenario20 PasswordSynchronisation | Samba AD or OpenLDAP | (ignored) | not yet measured | three provisioned accounts; the wait is delivery, not population. OpenLDAP skips the parked-change retry test (no password policy in the lab) |
