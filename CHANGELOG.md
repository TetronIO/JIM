...
- 🐛 Save and create buttons now react as you type in a name field instead of waiting for the field to lose focus: typing a name enables the Create Synchronisation Rule button immediately, and clearing a Connected System's or Run Profile's name disables its save button immediately.
