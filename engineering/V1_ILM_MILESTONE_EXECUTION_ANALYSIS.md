...
**Milestone: 35 closed / 39 open (74 total, ~47% complete)** as of 2026-07-11. The milestone has grown beyond the original 57-issue analysis as new issues were raised, so the fixed "in-scope" denominator no longer tracks it; counts here follow the live milestone. **Reconciliation (2026-07-15):** every issue/PR reference in this document that is closed or merged has been struck through; the live milestone remains the authoritative source for current counts (the snapshot figure above is not re-counted here). Four issues have also left this milestone since the analysis: [#9](https://github.com/TetronIO/JIM/issues/9) and [#294](https://github.com/TetronIO/JIM/issues/294) moved to v2.0-IGA-FOUNDATION; [#186](https://github.com/TetronIO/JIM/issues/186) and [#437](https://github.com/TetronIO/JIM/issues/437) removed to the backlog (no milestone). They are struck through in the priority tiers (Section 3) and full issue index (Section 8); scattered cross-references elsewhere are left in place as context.
