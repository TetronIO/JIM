...
- **Status:** Doing (Phases 0, 2, 3 and 4 complete; the framework is proven end-to-end by two shipped adapters. Phase 5 is the remaining work: Wave 1's G5 has landed and its G3 half (#1115) has not, Wave 2 is delivered, and Waves 3 and 4 are unfiled. Phase 1, the #288 engine core, is the critical path: it blocks #1115's outbound side and the whole of Wave 3)
- **Created:** 2026-07-20
...
- [ ] **Wave 3:** G1/G2 (Synchronisation Rule scope and Attribute Flow changes; the heaviest evaluation, fully dependent on #288). Not yet filed as issues; file them once Phase 1 has a shape to write against, per #827's acceptance criterion that waves are split as they start rather than pre-empting the contract.
- [ ] **Wave 4:** G6 and remaining toggles; re-scope #204, #134/#809, #421, and #91 mode 2 as adapter issues. Not yet filed.

**Where Phase 5 actually stands (Aug 2026):** two of six gaps have adapters (G5, G4), and both were the ones reachable without the engine core. Everything left is behind Phase 1: G3's outbound half needs the evaluation-only export path, and G1/G2 need the whole engine. That makes **#288 the critical path for the rest of this framework**, not the next adapter issue; filing more adapter issues ahead of it would produce a backlog that cannot be started.
