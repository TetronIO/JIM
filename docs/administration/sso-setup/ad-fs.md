...
2. Add the **Redirect URI**: `https://your-jim-url/signin-oidc` (`your-jim-url` is JIM's address, port included: `jim.example.com:5200` for a default installation), then click **Add**
