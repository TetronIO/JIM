...
<#
.SYNOPSIS
    Configure JIM for Scenario 008: Cross-domain Entitlement Synchronisation
...
.EXAMPLE
    ./Setup-Scenario-008.ps1 -ApiKey "jim_abc123..."

.EXAMPLE
    ./Setup-Scenario-008.ps1 -Template Small -ApiKey "jim_abc123..."
#>
...
# Scenario 008 OpenLDAP uses jimGroup (SUP groupOfNames) which adds mail, jimGroupType, jimGroupStatus,
...
Write-TestSection "Scenario 008 Setup: Cross-domain Entitlement Synchronisation"
...
Write-Host ""
Write-Host "Scenario 008 setup complete" -ForegroundColor Green
Write-Host ""
