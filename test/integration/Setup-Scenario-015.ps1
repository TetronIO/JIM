...
<#
.SYNOPSIS
    Configure JIM for Scenario 015: SCIM 2.0 Client Connector
...
.EXAMPLE
    ./Setup-Scenario-015.ps1 -JIMUrl "http://localhost:5200" -ApiKey "jim_abc123..."
#>
...
$hrCsvFilePath = "/connector-files/test-data/scenario-015-hr-users.csv"
...
Write-TestSection "Scenario 015 Setup: SCIM 2.0 Client Connector"
...
Write-TestSection "Scenario 015 Setup Complete"
