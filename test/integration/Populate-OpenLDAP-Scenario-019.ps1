...
<#
.SYNOPSIS
    Populate OpenLDAP with test data for Scenario 019: Auxiliary Classes
...
.DESCRIPTION
    ...
    following Scenario 014's two-suffix shape.
    ...
    - Dora (index 3) carries no badge class in either suffix; her GLITTERBAND entry carries
      ...
      attribute as a second-system contributor (the cross-system priority fallback Scenario 014
...
.EXAMPLE
    ./Populate-OpenLDAP-Scenario-019.ps1
#>
...
Write-TestSection "Scenario 019: Populating OpenLDAP (Source + Target) with Auxiliary Class test data"
...
Write-TestSection "Scenario 019 OpenLDAP Population Complete"
...
Write-Host ""
Write-Host "Scenario 019 OpenLDAP population complete" -ForegroundColor Green
