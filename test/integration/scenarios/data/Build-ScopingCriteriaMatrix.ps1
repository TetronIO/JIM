...
<#
.SYNOPSIS
    Generates the canonical Scenario 011 scoping criteria matrix manifest.
...
.DESCRIPTION
    ...
    tuple. The scenario script (Invoke-Scenario-011-ScopingCriteriaMatrix.ps1) reads
...
$manifest = [ordered]@{
    schemaVersion = 1
    description = 'Scenario 011 - Scoping Criteria Evaluation Matrix. Generated by Build-ScopingCriteriaMatrix.ps1; do not edit by hand. To regenerate run pwsh test/integration/scenarios/data/Build-ScopingCriteriaMatrix.ps1.'
