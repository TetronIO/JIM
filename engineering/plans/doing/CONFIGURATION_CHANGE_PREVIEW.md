...
- **Status:** Doing (Phases 0 to 4 complete; the framework is proven end-to-end by two shipped adapters, and the #288 engine core (Phase 1) delivered Aug 2026. Phase 5 is the remaining work: Wave 1's G5 has landed and its G3 half (#1115) is now unblocked, Wave 2 is delivered, and Waves 3 and 4 are unfiled but fileable)
- **Created:** 2026-07-20
...
- [ ] **Wave 3:** G1/G2 (Synchronisation Rule scope and Attribute Flow changes; the heaviest evaluation, fully dependent on #288). Not yet filed as issues; **fileable since Aug 2026**: Phase 1 delivered the shape to write against (`JimApplication.SyncPreview`, configuration as a parameter throughout), per #827's acceptance criterion that waves are split as they start rather than pre-empting the contract.
- [ ] **Wave 4:** G6 and remaining toggles; re-scope #204, #134/#809, #421, and #91 mode 2 as adapter issues. Not yet filed.

**Where Phase 5 actually stands (Aug 2026):** two of six gaps have adapters (G5, G4), and both were the ones reachable without the engine core. **Phase 1 has since delivered**, so nothing left is engine-blocked: G3 (#1115) has its evaluation-only export path, and G1/G2 have the whole engine and are fileable. The critical path is now the adapter work itself, in severity order.
