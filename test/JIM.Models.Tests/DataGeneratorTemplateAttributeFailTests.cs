...
namespace JIM.Models.Tests
{
    public class DataGeneratorTemplateAttributeFailTests
    {
        ...
        public void TestIsValidBoolMismatchFail()
        {
            var subject1 = new DataGenerationTemplateAttribute
            {
                ConnectedSystemAttribute = new ConnectedSystemObjectTypeAttribute { Type = AttributeDataType.Bool },
                PopulatedValuesPercentage = 100,
                Pattern = "dummy-value"
            };
            Assert.Catch<DataGeneratationTemplateAttributeException>(subject1.Validate);
        ...
        public void TestIsValidDateTimeMismatchFail()
        {
            var subject1 = new DataGenerationTemplateAttribute
            {
                ConnectedSystemAttribute = new ConnectedSystemObjectTypeAttribute { Type = AttributeDataType.DateTime },
                PopulatedValuesPercentage = 100,
                Pattern = "dummy-value"
            };
            Assert.Catch<DataGeneratationTemplateAttributeException>(subject1.Validate);
        ...
        public void TestIsValidManagerFail()
        {
            ...
            {
                ConnectedSystemAttribute = new ConnectedSystemObjectTypeAttribute { Type = AttributeDataType.String, Name = Constants.BuiltInAttributes.Manager },
                ManagerDepthPercentage = 50
            };
