...
namespace JIM.PostgresData.Migrations
{
    ...
    [Migration("20220811070347_PredefinedSearchDefaultFor")]
    partial class PredefinedSearchDefaultFor
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("MetaverseAttributePredefinedSearch", b =>
                {
                    b.Property<int>("MetaverseAttributesId")
                        .HasColumnType("integer");

                    b.Property<int>("PredefinedSearchesId")
                        .HasColumnType("integer");

                    b.HasKey("MetaverseAttributesId", "PredefinedSearchesId");

                    b.HasIndex("PredefinedSearchesId");

                    b.ToTable("MetaverseAttributePredefinedSearch");
                });
            ...
            modelBuilder.Entity("MetaverseAttributePredefinedSearch", b =>
                {
                    b.HasOne("JIM.Models.Core.MetaverseAttribute", null)
                        .WithMany()
                        .HasForeignKey("MetaverseAttributesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("JIM.Models.Search.PredefinedSearch", null)
                        .WithMany()
                        .HasForeignKey("PredefinedSearchesId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
