...
/// <summary>
/// Defines a source for a Synchronisation Rule mapping. Can hold either an attribute or an expression.
/// If it is an attribute, then depending on the direction of the Synchronisation Rule (import/export), then it'll
...
public class SyncRuleMappingSource
{
    ...
    /// <summary>
    /// For Export Synchronisation Rules only: If populated, denotes that a Metaverse Attribute should be used to set the target attribute value.
    /// </summary>
    public MetaverseAttribute? MetaverseAttribute { get; set; }
    public int? MetaverseAttributeId { get; set; }

    /// <summary>
    /// For Import Synchronisation Rules only: If populated, denotes that a Connected System Attribute should be used to set the target attribute value.
    /// </summary>
