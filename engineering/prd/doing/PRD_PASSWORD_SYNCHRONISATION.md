...
Three decisions taken after Phase 1 shipped under Unreleased, recorded here because they change requirements this PRD stated. Implementation plan: [`engineering/plans/doing/PASSWORD_PIPELINE_CONVERGENCE.md`](../../plans/doing/PASSWORD_PIPELINE_CONVERGENCE.md), issue [#1635](https://github.com/TetronIO/JIM/issues/1635).
