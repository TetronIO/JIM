...
> **See also**: [ATTRIBUTE_PRIORITY.md](ATTRIBUTE_PRIORITY.md) for the detailed design of how attribute priority is determined when multiple sources contribute to the same attribute (Issue #91).
...
- [ATTRIBUTE_PRIORITY.md](ATTRIBUTE_PRIORITY.md) - Determining the authoritative source when multiple systems contribute to the same attribute (Issue #91; design approved, implementation deferred)
