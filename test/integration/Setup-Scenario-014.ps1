...
<#
.SYNOPSIS
    Configure JIM for Scenario 014: Attribute Priority
...
.DESCRIPTION
    ...
    Creates:
    - "Scenario 014 Primary" Connected System, base DN = dc=yellowstone,dc=local
    - "Scenario 014 Secondary" Connected System, base DN = dc=glitterband,dc=local
    ...
    for Scenario 014 before this script is ever invoked.
...
.PARAMETER DirectoryConfig
    ...
    which OpenLDAP instance is passed in, mirroring Setup-Scenario-008.ps1's Source/Target split.

.EXAMPLE
    ./Setup-Scenario-014.ps1 -ApiKey "jim_abc123..."
#>
...
if ($DirectoryConfig.DirectoryType -ne "OpenLDAP") {
    throw "Scenario 014 (Attribute Priority) is OpenLDAP only. Run-IntegrationTests.ps1 should have rejected this combination before Setup-Scenario-014.ps1 was invoked; check the -DirectoryType hard-fail near Test-LongTailTemplateCompatibility."
}

# Re-derive Primary (Yellowstone) and Secondary (Glitterband) configuration independently of
# whichever single OpenLDAP instance was passed in, mirroring Setup-Scenario-008.ps1.
...
Write-TestSection "Scenario 014 Setup: Attribute Priority"
...
# Setup-Scenario-008.ps1 / Setup-Scenario-009.ps1.
$sharedMappings = @(
...
# Summary
# ============================================================================
Write-TestSection "Scenario 014 Setup Complete"
