...
<#
.SYNOPSIS
    Populate OpenLDAP with test data for Scenario 008: Cross-domain Entitlement Sync
...
.EXAMPLE
    ./Populate-OpenLDAP-Scenario-008.ps1 -Template Nano -Instance Source

.EXAMPLE
    ./Populate-OpenLDAP-Scenario-008.ps1 -Template Nano -Instance Source -DirectoryType DirectoryServer389

.EXAMPLE
    ./Populate-OpenLDAP-Scenario-008.ps1 -Template Small -Instance Source
#>
...
Write-TestSection "Scenario 008: Populating $DirectoryType ($Instance) with $Template template"
...
# Company and department lists matching Samba AD S008 pattern
...
# S008 uses ou=Groups for entitlement groups (matching the existing OpenLDAP hierarchy).
