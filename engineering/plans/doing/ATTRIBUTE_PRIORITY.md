...
> - **Still open (separate increments):** priority-aware drift *contributor* check (distinct from the value filter above), the `SyncOutcome` **NoContributor** node, and reference-attribute re-election. UI is Phase 3.
