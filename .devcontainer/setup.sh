...
if dotnet tool install --global dotnet-ef --version 10.0.12; then
    print_success "dotnet-ef 10.0.12 installed globally"
else
    print_warning "dotnet-ef installation failed - you may need to install manually: dotnet tool install --global dotnet-ef --version 10.0.12"
fi
