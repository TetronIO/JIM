...
{
    public class ConnectedSystemSchemaObjectType
    {
        /// <summary>
        ...
        public List<ConnectedSystemSchemaAttribute> Attributes { get; set; }
        ...
        /// </summary>
        public ConnectedSystemSchemaAttribute? RecommendedUniqueIdentifierAttribute { get; set; }

        public ConnectedSystemSchemaObjectType(string name)
        {
            Name = name;
            Attributes = new List<ConnectedSystemSchemaAttribute>();
        }
    }
}
