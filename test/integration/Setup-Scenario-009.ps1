...
<#
.SYNOPSIS
    Configure JIM for Scenario 009: Partition-Scoped Imports
...
.EXAMPLE
    ./Setup-Scenario-009.ps1 -JIMUrl "http://localhost:5200" -ApiKey "jim_abc123..."

.EXAMPLE
    ./Setup-Scenario-009.ps1 -ApiKey "jim_abc123..." -DirectoryConfig (Get-DirectoryConfig -DirectoryType OpenLDAP)
#>
...
Write-TestSection "Scenario 009 Setup: Partition-Scoped Imports ($systemName)"
...
Write-TestSection "Scenario 009 Setup Complete"
