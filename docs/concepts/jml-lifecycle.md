...
JIM handles each phase through its [synchronisation rules](sync-rules.md) and [sync pipeline](sync-pipeline.md), applying the appropriate actions automatically based on your configuration.
