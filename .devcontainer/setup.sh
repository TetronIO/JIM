...
echo "  jim-db             - Start PostgreSQL + Adminer"
echo ""
echo "Docker Stack Commands:"
echo "  jim-stack          - Start Docker stack (production-like, no dev tools)"
echo "  jim-stack-dev      - Start Docker stack + Adminer"
echo "  jim-stack-logs     - View Docker stack logs"
echo "  jim-stack-down     - Stop Docker stack"
echo ""
echo "Docker Builds (rebuild services):"
echo "  jim-build          - Build all services + start (no dev tools)"
echo "  jim-build-dev      - Build all services + start + Adminer"
...
echo "  Adminer:           http://localhost:8080 (when using jim-db or jim-stack-dev)"
echo ""
