...
3. Samba creates the Deleted Objects container on the domain's first deletion, so a freshly provisioned domain has nothing to delegate over until one throwaway object has been created and deleted.
