...
- **Status:** Doing (decisions D1 to D5 settled Aug 2026; outbound extraction complete (plan Phases 0 and 1); the evaluation-only outbound path (plan Phase 2) underway)
- **Created:** 2026-07-07
