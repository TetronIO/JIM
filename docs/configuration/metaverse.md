...
- **Current value**<br /> The value, its source (the Connected System and Synchronisation Rule it came from), the Connected System Object that supplied it, and the Activity that last set it.
...
- **History**<br /> Every recorded change to the attribute, newest first, with the Activity and Synchronisation Rule behind each. **Open in Timeline** takes you to the object's full change history.
