...
<#
.SYNOPSIS
    Configure JIM for Scenario 002: Directory to Directory Synchronisation
...
.EXAMPLE
    ./Setup-Scenario-002.ps1 -JIMUrl "http://localhost:5200" -ApiKey "jim_abc123..."

.EXAMPLE
    ./Setup-Scenario-002.ps1 -Template Small

.NOTES
    This script requires:
    - JIM PowerShell module
    - JIM running and accessible
    - Panoply APAC and EMEA containers running (docker compose --profile scenario-002)
#>
...
Write-TestSection "Scenario 002 Setup: Directory to Directory Synchronisation ($directoryType)"
...
Write-Host ""
Write-Host "✓ Scenario 002 setup complete" -ForegroundColor Green
Write-Host ""
